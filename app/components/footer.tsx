...
export default function LargeWithNewsletter() {
    return (
        <Box
            bg={useColorModeValue('#285E61', 'gray.900')}
                ...
                <SimpleGrid
                    ...
                    <Stack spacing={6}>
                        ...
                        <Stack direction={'row'} spacing={6}>
                            ...
                            <SocialButton label={'Facebook'} href={'https://www.facebook.com/piaic'}>
                                <FaFacebook />
                            </SocialButton>
                    ...
                    <Stack align={'flex-start'}>
                        ...
                        <Link href={'#'} _hover={{color:'black'}}>How to Works</Link>
                        <Link href={'#'} _hover={{color:'black'}}>About</Link>
                        <Link href={'#'} _hover={{color:'black'}}>Women Inclusion in Technology (WIT)</Link>
                    </Stack>
                    <Stack align={'flex-start'}>
                        <ListHeader>Available Course</ListHeader>
                        <Link href={'#'} _hover={{color:'black'}}>Artifical Intelligence</Link>
                        <Link href={'#'} _hover={{color:'black'}}>Cloud Native and Mobile Web Developer</Link>
                        <Link href={'#'} _hover={{color:'black'}}>Blockchain</Link>
                        <Link href={'#'} _hover={{color:'black'}}>Internet of Things</Link>
                        <Link href={'#'} _hover={{color:'black'}}>Web 3.0 and Metaverse Developer</Link>
                    </Stack>
                    <Stack align={'flex-start'}>
            <ListHeader>PIAIC HelpLine</ListHeader>
            <Stack direction={'row'}>
              <Input
